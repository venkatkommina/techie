      ...
      <div className="rounded-3xl p-4 h-full">
        <div className="w-full h-full p-2 flex flex-col justify-evenly items-center text-center">
          ...
          <div className="flex flex-col">
            <Link href={`tel:${phone}`}><FontAwesomeIcon icon={faPhone} className="fas fa-phone text-green-500"></FontAwesomeIcon> {phone}</Link>
            <Link href={`mailto:${email}`}><FontAwesomeIcon icon={faEnvelope} className="fas fa-envelope text-green-500"></FontAwesomeIcon> {email}</Link>
          </div>
        </div>
      </div>
    </div>
